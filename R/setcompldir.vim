...
if !filereadable(g:rplugin.compldir . "/README")
    ...
    if readfile(g:rplugin.compldir . "/README")[0] != 'Last change in this file: 2022-11-26'
        let s:need_readme = 1
    endif
endif
if s:need_readme
    ...
    unlet s:flist
    let s:readme = ['Last change in this file: 2022-11-26',
                \ 'The files in this directory were generated by Nvim-R automatically:',
                \ 'The omnils_ are used for omni completion, the fun_ files for syntax ',
                \ 'highlighting, and the descr_ files for library decription in the ',
