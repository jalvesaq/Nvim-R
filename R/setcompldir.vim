...
if !filereadable(g:rplugin_compldir . "/README")
    ...
    if lines[0] != "The files in this directory were generated by Nvim-R and nvimcom."
        let s:need_readme = 1
    endif
endif
if s:need_readme
    let s:readme = ['The files in this directory were generated by Nvim-R and nvimcom.',
