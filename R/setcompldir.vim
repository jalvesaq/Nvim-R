...
if !filereadable(g:rplugin.compldir . "/README")
    ...
    if readfile(g:rplugin.compldir . "/README")[0] != 'Last change in this file: 2022-12-08'
        let s:need_readme = 1
    endif
endif
if s:need_readme
    ...
    unlet s:flist
    let s:readme = ['Last change in this file: 2022-12-08',
                ...
                \ 'highlighting, and the inst_libs files for library decription in the ',
                ...
                \ '',
                \ 'If you delete this README file, all omnils_ and fun_ files will be ',
                \ 'regenerated.',
                \ '',
