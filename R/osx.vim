...
function StartR_OSX()
    ...
    if g:rplugin_r_args_str != " "
        ...
        call RWarningMsg('R.app does not support command line arguments. To pass "' . g:rplugin_r_args_str . '" to R, you must put "let R_applescript = 0" in your nvimrc to run R in a terminal emulator.')
    endif
